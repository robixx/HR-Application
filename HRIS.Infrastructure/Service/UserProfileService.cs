...
namespace HRIS.Infrastructure.Service
{
    public class UserProfileService : IUserProfile
    {
        ...
        public async Task<List<AttendanceLogDto>> getIndividualAttendance(string startdate, string enddate, long EmployeeId)
        {
            try
            {
                List<DashBord_Individual_AttendanceDto> userlogs = new List<DashBord_Individual_AttendanceDto>();
                ...
                var data_userlogs = await _context.app_hris_attendance
                            ...
                            .Select(p => new DashBord_Individual_AttendanceDto
                            {
                                attnId = p.attnId,
                ...
                userlogs = (from log in data_userlogs
                            ...
                            select new DashBord_Individual_AttendanceDto
                            {
                                attnId = log.attnId,
                ...
                foreach (var missingDate in missingDates)
                {
                    ...
                    userlogs.Add(new DashBord_Individual_AttendanceDto
                    {
                        attnId = 0,
                        employeeId = empId,
